    ...
    public class ClassSelect
    {
        ...
        public DataTable SelectOpration(string TableName)
        {
            ...
            try
            {
                ...
                Conn.Open();
                OleDbDataAdapter Adapter = new OleDbDataAdapter(SelectStatment, Conn);
                Adapter.Fill(DS);
                Conn.Close();
        ...
        public DataTable SelectOpration(string TableName, string[] orderColName)
        {
            ...
            try
            {
                ...
                string SelectStatment = "select * From " + TableName + " order by " + orederCols;
        ...
        public DataTable SelectOpration(string[] ColumnName, string TableName)
        {
            ...
            try
            {
                ...
                string SelectStatment = "select " + SpecificCols + " From " + TableName;
        ...
        public DataTable SelectOpration(string[] ColumnName, string TableName, string[] orderColName)
        {
            ...
            try
            {
                ...
                string SelectStatment = "select " + SpecificCols + " From " + TableName + " order by " + orederCols;
        ...
        public DataTable SelectOpration(string TableName, string[] WhereColName, string[] WhrereColValue)
        {
            ...
            try
            {
                ...
                string SelectStatment = "select * From " + TableName + " Where " + WhereStatment;
                                   ...
                                   , string[] WhrereColValue, string[] orderColName)
        {
            ...
            try
            {
                ...
                string SelectStatment = "select * From " + TableName + " Where " + WhereStatment + " order by " + orederCols;
                                   ...
                                   , string[] WhereColName, string[] WhrereColValue)
        {
            ...
            try
            {
                ...
                string SelectStatment = "select " + SpecificCols + " From " + TableName + " Where " + WhereStatment;
                                   ...
                                   , string[] orderColName)
        {
            ...
            try
            {
                ...
                string SelectStatment = "select " + SpecificCols + " From " + TableName + " Where " + WhereStatment + " order by " + orederCols;
                                   ...
                                   , string[] S_Column, join[] JOIN)
        {
            ...
            try
            {
                ...
                string SelectStatment = "select " + ColsName + " from " + Tables;
                                    ...
                                    , string[] orderTable, string[] orderColumn)
        {
            ...
            try
            {
                ...
                string SelectStatment = "select " + ColsName + " from " + Tables + " order by " + orederCols;
                                   ...
                                   , string[] TableWhere, string[] Column_where, string[] WhrerValue)
        {
            ...
            try
            {
                ...
                string SelectStatment = "select " + ColsName + " from " + Tables + WhereStatment;
                                   ...
                                   , string[] orderTable, string[] orderColumn)
        {
            ...
            try
            {
                ...
                string SelectStatment = "select " + ColsName + " from " + Tables + WhereStatment + " order by " + orederCols;
        ...
        public DataTable SelectOpration(string[] ColumnName, string[] as_Name, string TableName)
        {
            ...
            try
            {
                ...
                string SelectStatment = "Select " + ColsName + " from " + TableName;
        ...
        public DataTable SelectOpration(string[] ColumnName, string[] as_Name, string TableName, string[] orderColumn)
        {
            ...
            try
            {
                ...
                string SelectStatment = "Select " + ColsName + " from " + TableName + " order by " + orederCols;
                                   ...
                                   , string[] WhereColName, string[] WhrereColValue)
        {
            ...
            try
            {
                ...
                string SelectStatment = "Select " + ColsName + " from " + TableName + " where " + WhereStatment;
                                   ...
                                   , string[] WhereColName, string[] WhrereColValue, string[] orderColumn)
        {
            ...
            try
            {
                ...
                string SelectStatment = "Select " + ColsName + " from " + TableName + " where " + WhereStatment + " order by " + orederCols;
                                   ...
                                   , join[] JOIN, string[] TableWhere, string[] ColumnWhere, string[] WhrerValue)
        {
            ...
            try
            {
                ...
                string SelectStatment = "select " + ColsName + " from " + Tables + " where " + WhereStatment;
                                   ...
                                   , string[] orderTable, string[] orderColumn)
        {
            ...
            try
            {
                ...
                string SelectStatment = "select " + ColsName + " from " + Tables + " where " + WhereStatment + " order by " + orederCols;
