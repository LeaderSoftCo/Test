   ...
   public  class ClassInsert
    {
        ...
        public void InsertOpration(string[] SqlColumens, string[] SqlValue, string TableName, bool ShowMessageBox)
        {
            ...
            //{
                ...
                string InsertStatment = "insert into " + TableName + " ( " + SQLColumnes + " ) Values (" + SQLColumnesValue + " ) ";
                ...
                Conn.Open();
                OleDbDataAdapter Adapter = new OleDbDataAdapter(InsertStatment, Conn);
                Adapter.Fill(DS);
                Conn.Close();
         ...
         //   }
            ...
            //catch
            //{
            //    MessageBox.Show("خطأ في إدخال البيانات");
            //}
