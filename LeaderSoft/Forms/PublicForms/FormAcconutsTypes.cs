...
{
    public partial class FormAcconutsTypes : Form
    {
        ...
        public void SearchID(DataTable DtID)
        {
            ...
            foreach (DataRow row in DtID.Rows)
            {
                ...
                if (row[TableAcconutsTypes.ID].ToString() == TextBoxID.Text)
                {
        ...
        private void ToolsStatus()
        {
            if (_TypeOperation == ClassPublicVar.TypeOperation.Show)
            {
                ...
                buttonMainSearch.Enabled = false;
        ...
        private void FormAcconutsTypes_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                _ClassFillTree.FillTree(TreeViewMain, _ClassSelect.SelectOpration("TableAcconutsTypes"), TableAcconutsTypes.GroupID , TableAcconutsTypes.ID, TableAcconutsTypes.NameLng1, TableAcconutsTypes.IsGroup);
        ...
        private void TreeViewMain_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            dt = _ClassSelect.SelectOpration("TableAcconutsTypes", new string[] { "ID" }, new string[] { NodeID });

            try
            {
                if (_TypeOperation == ClassPublicVar.TypeOperation.Show)
                {
                    TextBoxID.Text = dt.Rows[0][TableAcconutsTypes.ID].ToString();

                    TextBoxGroupID.Text = dt.Rows[0][TableAcconutsTypes.GroupID].ToString();

                    TextBoxGroupName.Text = dt.Rows[0][TableAcconutsTypes.GroupName].ToString();

                    TextBoxNameLng1.Text = dt.Rows[0][TableAcconutsTypes.NameLng1].ToString();

                    TextBoxNameLng2.Text = dt.Rows[0][TableAcconutsTypes.NameLng2].ToString();

                    if (dt.Rows[0][TableAcconutsTypes.IsGroup].ToString() == "0")
                    {
                        RadioBtnNotGroup.Checked = true;
                    }
                    else
                ...
                {
                    TextBoxGroupID.Text = dt.Rows[0][TableAcconutsTypes.ID].ToString();

                    TextBoxGroupName.Text = dt.Rows[0][TableAcconutsTypes.NameLng1].ToString();
        ...
        {
            IDDataTable = _ClassSelect.SelectOpration(new string[] { TableAcconutsTypes.ID }, "TableAcconutsTypes");
        ...
        private void TextBoxGroupID_Leave(object sender, EventArgs e)
        {
            try
            {
                ...
                DTGroupID = _ClassSelect.SelectOpration(new string[] { TableAcconutsTypes.ID, TableAcconutsTypes.GroupName, TableAcconutsTypes.NameLng1, TableAcconutsTypes.IsGroup }, "TableAcconutsTypes");
                ...
                else
                {
                    foreach (DataRow row in DTGroupID.Rows)
                    {
                        ...
                        if (row[TableAcconutsTypes.ID].ToString() == TextBoxGroupID.Text)
                        {


                            if (row[TableAcconutsTypes.IsGroup].ToString() == "0")
                            {
                            ...
                            {
                                TextBoxGroupID.Text = row[TableAcconutsTypes.ID].ToString();
                                TextBoxGroupName.Text = row[TableAcconutsTypes.NameLng1].ToString();
                                Exsists = true;
                                break;
                            }
                        }
            ...
            try
            {
                ...
                if (_TypeOperation == ClassPublicVar.TypeOperation.Add)
                {
                    if (TextBoxGroupID.Text != "" && TextBoxGroupID.Text != " ")
                    {
                        ...
                        {
                            _ClassInsert.InsertOpration(new string[] { TableAcconutsTypes.ID , TableAcconutsTypes.GroupID , TableAcconutsTypes.GroupName , TableAcconutsTypes.NameLng1
                                                                     ,  TableAcconutsTypes.NameLng2 , TableAcconutsTypes.IsGroup}
                ...
                else if (_TypeOperation == ClassPublicVar.TypeOperation.Edit)
                {
                    if (TextBoxGroupID.Text != "" && TextBoxGroupID.Text != " ")
                    {
                        ...
                        if (RadioBtnGroup.Checked)
                        {
                            _ClassUpdate.UpdateOpration(new string[] { TableAcconutsTypes.ID , TableAcconutsTypes.GroupID , TableAcconutsTypes.GroupName , TableAcconutsTypes.NameLng1
                                                                     , TableAcconutsTypes.NameLng2 , TableAcconutsTypes.IsGroup}
                                                       , new string[] { TextBoxID.Text , TextBoxGroupID.Text , TextBoxGroupName.Text ,
                                                                       TextBoxNameLng1.Text , TextBoxNameLng2.Text , "1"}
                                                       , new string[] { TableCostCenter.ID }, new string[] { NodeID }
                                                       , "TableAcconutsTypes", true);
                        }
                        else if (RadioBtnNotGroup.Checked)
                        {
                            _ClassUpdate.UpdateOpration(new string[] { TableAcconutsTypes.ID , TableAcconutsTypes.GroupID , TableAcconutsTypes.GroupName, TableAcconutsTypes.NameLng1
                ...
                FormAcconutsTypes_Load(sender, e);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
        ...
        private void ButtonDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                _ClassDelete.DeleteOpration(new string[] { TableAcconutsTypes.ID }, new string[] { NodeID }, "TableAcconutsTypes", true);
                FormAcconutsTypes_Load(sender, e);
            }
        }
        ...
        {
            TreeSearchForm _TreeSearchForm = new TreeSearchForm("TableAcconutsTypes", true);
